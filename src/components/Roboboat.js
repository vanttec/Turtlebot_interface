...
class Roboboat extends React.Component<Props, State> {
    state = {
      autoExpand: true,
      layouts: {},
      widgets: [],
        ...
        <div className="container-fluid">
            <div className="row flex-xl-nowrap">
                ...
                <div id="nav" className="col-12 col-md-3 col-xl-2 bd-sidebar">
                    <div className="row">
                        <div className="col-md-12 col-8">
                            <div className="text-sm-left text-md-center logo">ROBOT INTERFACE</div>
                        </div>
                        <div className="col-md-12 col-4 text-right">
                            ...
                            <button className="btn btn-link bd-search-docs-toggle d-md-none p-0 ml-3 collapsed" type="button" data-toggle="collapse" data-target="#bd-docs-nav"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30" height="30" focusable="false">
                                    <title>Menu</title>
                                    <path stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeMiterlimit="10" d="M4 7h22M4 15h22M4 23h22"></path>
                                </svg>
                            </button>
                        </div>
                    </div>
                ...
                <div id="content-body" className="col-12 col-md-9 col-xl-10 pl-4 pr-4 bd-content">
                    {/* <!-- heading row --> */}
                    <div className="row">
                        <div className="col-md-12 pt-4 mt-3"><h2>Robot Dashboard</h2></div>
                    </div>
                    {/* <!-- heading row end-->
